...
class hyperge1(base_ff):
    """Fitness function for tuning the optimal hyperparameter for Resnet model."""
    maximise = True
    global hist
    ...
    def evaluate(self, ind, **kwargs):
            ...
            data_dir = "/home/gauri/caltech-101"
            ...
            if feature_extract:
                ...
                optimizer_ft = optim.Adagrad(params_to_update, lr=0.0255)
            ...
            List = [a[0], a[1], a[2], a[3], final_fitness, params,train_model.time_elapsed]

            with open('caltech101_hyperge.csv', 'a') as f_object:
