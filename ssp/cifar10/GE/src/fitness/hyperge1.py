...
class hyperge1(base_ff):
    ...
    def evaluate(self, ind, **kwargs):
            ...
            #   to the ImageFolder structure The image folder should contain train-test-val
            data_dir = "/Users/orphic/Downloads/HyperGE/datasets_main/maindatasets/cifar10_main"
            ...
            with open('cifar10_hyperge.csv', 'a') as f_object:
